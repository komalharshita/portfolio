  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-40 p-3 rounded-full shadow-lg hover:shadow-[0_0_30px_rgba(255,77,166,0.5)] transition-all duration-300 hover:scale-110 animate-pulse"
