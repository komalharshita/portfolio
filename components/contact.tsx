...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-pattern-overlay relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 max-w-7xl mx-auto">
      {/* CONTACT NETWORK PATTERN */}
      <div className="bg-contact-pattern absolute inset-0 pointer-events-none" />
